...
public class DefaultMailManager implements MailManager {
    ...
    public void send(String emailAddress, String subject, String template, MessageVariable... variables) {
        Assert.hasText(emailAddress, "Parameter `emailAddress` 공백 안돼요");
        Assert.hasText(subject, "Parameter `subject` 공백 안돼요");
        Assert.hasText(template, "Parameter `template` 공백 안돼요");
